 ...
 */
@Path(Constants.Path.GETBOTTLECHECKLISTPATH)
public class BottleCheckedListRequest extends IRequest {
    private String[] args;

    public BottleCheckedListRequest(Context context, IRequestListener listener, String... args) {
