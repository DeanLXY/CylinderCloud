...
public class CheckedListResponse extends IRequest {
    ...
    protected String prapareMsg() {
        //TODO
        return "zzxkzbh=TS2210021-2013&jyrqStart=2014-10-1&jyrqEnd=2014-10-31&token="+this.getToken()+"_cccc_cphm_djbh_cpxh_cjh_fdjh_syxz_color_regUnit_gd_zzgb_jybh_zzdm_zzxkzbh_ccrq_zcbh_xjrq_bfrq_azdw_cqjz_CNGID_unitName_licenseNO_licEnd_updateTime";
    }
}
